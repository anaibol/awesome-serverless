...
* [Kuzzle](https://kuzzle.io) - High performance self hostable backend solution including persistence, authentication, realtime database and geofencing with a full featured cluster mode.
